                ...
                <section className="products">
                    ...
                    <ul className="products_list">
                        <li className="product current">
                            ...
                            <p className="product_gost">ГОСТ 14911-82</p>
                            <h3 className="product_description">Опора корпусная приварная КП</h3>
                            <div className="product_price-wrapper">
                                <p className="product_price">849.9 руб.</p>
